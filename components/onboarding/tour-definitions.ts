/**
 * Tour step definitions for the OnRampd onboarding guide.
  ...
  project: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Click "New Project". Select the client, choose a template, and set a start date. OnRampd will automatically generate all phases and tasks from your template.',
