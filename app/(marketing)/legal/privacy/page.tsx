      ...
      <div className="prose prose-slate max-w-none text-sm leading-relaxed space-y-8">
        <div>
          ...
          <p className="text-slate-600">
            ...
            LaunchTrack, such as project activity and engagement data.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1 text-slate-600">
            <li>Provide, maintain, and improve LaunchTrack</li>
        ...
        <div>
          ...
          <p className="text-slate-600">
            ...
            time by contacting us at privacy@launchtrack.com.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-slate-600">
            ...
            <a href="mailto:privacy@launchtrack.com" className="text-blue-600 hover:underline">
              privacy@launchtrack.com
            </a>.
          </p>
        </div>
      </div>
