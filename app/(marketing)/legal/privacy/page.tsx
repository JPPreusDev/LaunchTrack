      ...
      <div className="prose prose-slate max-w-none text-sm leading-relaxed space-y-8">
        <div>
          ...
          <p className="text-slate-600">
            ...
            Rampify, such as project activity and engagement data.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1 text-slate-600">
            <li>Provide, maintain, and improve Rampify</li>
        ...
        <div>
          ...
          <p className="text-slate-600">
            ...
            time by contacting us at privacy@rampify.com.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-slate-600">
            ...
            <a href="mailto:privacy@rampify.com" className="text-red-700 hover:underline">
              privacy@rampify.com
            </a>.
          </p>
        </div>
