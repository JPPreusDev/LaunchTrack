    ...
    updates: [
      {
        type: 'New',
        items: [
          'Custom subdomain branding (myagency.launchtrack.com)',
      ...
      },
      {
        type: 'Improved',
        items: [
          'Portal login page now fully white-labeled — no LaunchTrack branding visible',
    ...
    updates: [
      {
        type: 'New',
        items: [
          'Initial release of LaunchTrack',
...
const TYPE_COLORS: Record<string, string> = {
  ...
  Improved: 'bg-blue-50 text-blue-700',
    ...
    <>
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pt-20 pb-12 text-center">
        ...
        <p className="text-slate-500 text-lg">
          Everything new in LaunchTrack — shipped regularly, documented openly.
        </p>
      </section>
